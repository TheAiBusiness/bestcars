...
import { Car, Users, ChartBar, Layers, Settings, Globe, LogOut, Menu } from 'lucide-react';
      ...
      <div className="flex flex-col h-screen bg-black overflow-hidden">
        <div className="flex items-center gap-3 px-4 py-3 border-b border-white/5 flex-shrink-0">
          <Sheet open={mobileOpen} onOpenChange={setMobileOpen}>
            ...
            <SheetContent
              side="left"
              className="w-64 p-0 bg-[#0a0e17]/95 border-white/10 backdrop-blur-2xl [&>button]:hidden"
            >
              <SidebarContent
          ...
          <h1 className="text-lg tracking-tight bg-gradient-to-br from-white via-white/90 to-white/70 bg-clip-text text-transparent">
            BestCars
          </h1>
        </div>
